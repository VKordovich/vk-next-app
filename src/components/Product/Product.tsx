...
import { priceRu } from '@/components/HhData/HhData';
		...
		<div className={className} {...props} ref={ref}>
			<Card className={styles.product}>
				...
				<div className={styles.price}>
					...
					{product.oldPrice && <Tag tagType={'info'} className={styles.oldPrice} color="green">
				...
				<div className={styles.tags}>{product.categories.map((c: any) => <Tag tagType={'info'} key={c} className={styles.category} color='ghost'>{c}</Tag>)}</div>
